<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserReceiveMessages.aspx.cs" Inherits="UserPanel_UserReceiveMessages" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>حس ششم - پیامهای دریافتی</title>
    <link href="../Styles/CSSUserProfile.css" rel="stylesheet" type="text/css" />
</head>
<body>
    <form id="form1" runat="server">    
    <div id="userReceiveMessages">   
        <h3>پیام های دریافتی از سوی سایر کاربران</h3>
        <hr />         
        <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
        <div>
            <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <asp:GridView ID="gv_UserReceiveMessages" EnableViewState="false" runat="server" AutoGenerateColumns="false" AllowPaging="true"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="فرستنده پیام" SortExpression="Message_SenderEmail">
                                <ItemStyle Width="15%"/>
                                <ItemTemplate>                    
                                    <asp:Label ID="lbl_Message_SenderEmail" runat="server" Text='<%# Eval("Message_SenderEmail") %>'></asp:Label>
                                </ItemTemplate>                            
                            </asp:TemplateField>
