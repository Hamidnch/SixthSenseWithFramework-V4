...
public partial class UserControl_SportMenu : System.Web.UI.UserControl
{
    protected void Page_Load(object sender, EventArgs e)
    {
        sportmenu_menuRace.ServerClick += new EventHandler(menuRace_ServerClick);
    ...
    public void menuRace_ServerClick(object sender, EventArgs e)
    {
        sportmenu_menuRace.CausesValidation = false;
