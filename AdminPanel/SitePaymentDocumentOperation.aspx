<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/Admin.master" AutoEventWireup="true" CodeFile="SitePaymentDocumentOperation.aspx.cs" Inherits="AdminPanel_SitePaymentDocumentOperation" %>

<%@ Register src="AdminUserControl/SitePaymentDocumentOperation.ascx" tagname="SitePaymentDocumentOperation" tagprefix="uc1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <uc1:SitePaymentDocumentOperation ID="SitePaymentDocumentOperation1" 
        runat="server" />
    </asp:Content>
