<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/Admin.master" AutoEventWireup="true" CodeFile="SiteReceiptDocumentOperation.aspx.cs" Inherits="AdminPanel_SiteReceiptDocumentOperation" %>

<%@ Register src="AdminUserControl/SiteReceiptDocumentOperation.ascx" tagname="SiteReceiptDocumentOperation" tagprefix="uc1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <uc1:SiteReceiptDocumentOperation ID="SiteReceiptDocumentOperation1" 
        runat="server" />
</asp:Content>
