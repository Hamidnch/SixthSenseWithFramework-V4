<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ReportCharitableBox.ascx.cs" Inherits="AdminPanel_AdminUserControl_ReportCharitableBox" %>
...
<fieldset>
    <legend style="color: #ffcc00;">گزارش صندوق عمومی(عام المنفعه)</legend>
    <fieldset>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <div>
                    <fieldset>
                        <asp:GridView ID="gv_charitableReport" runat="server" 
                            ...
                            AllowPaging="True" onpageindexchanging="gv_charitableReport_PageIndexChanging">
