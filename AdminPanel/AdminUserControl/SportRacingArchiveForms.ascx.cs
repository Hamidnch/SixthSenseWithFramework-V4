...
public partial class AdminPanel_AdminUserControl_SportRacingArchiveForms : System.Web.UI.UserControl
{
    public String ImagePath { get { return ResolveUrl("~/Images"); } }
    private void GetArchiveRacing()
    {
        ddl_RacingInfoID.Items.Clear();
        ddl_RacingInfoID.DataSource = DAL.Sport_GetArchiveDisableRacing();
    ...
    private void SearchForms()
    {
        ...
        gv_RacingArchiveForms.DataSource = DAL.Sport_LoadAllArchiveForms(infoId, userItems);
        gv_RacingArchiveForms.DataBind();
    }
    protected void gv_RacingArchiveForms_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        gv_RacingArchiveForms.PageIndex = e.NewPageIndex;
        SearchForms();
    }
    ...
    protected void gv_RacingArchiveForms_RowCommand(object sender, GridViewCommandEventArgs e)
    {
