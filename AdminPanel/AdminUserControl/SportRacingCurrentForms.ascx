<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SportRacingCurrentForms.ascx.cs" Inherits="AdminPanel_AdminUserControl_SportRacingCurrentForms" %>
<%@ Register Assembly="MultiDropDown" Namespace="MultiDropDownLib" TagPrefix="MultiDropDownLib" %>
<asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
<asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
        <fieldset>
            <legend style="color:#ffcc00;font-weight:bold;font-size:20px">صندوق فرمهای مسابقات در جریان </legend>
                ...
                <tr>
                    ...
                    <td>
                        <div style="float: right; padding: 0 10px">
                                ...
                                <MultiDropDownLib:MultiDropDown ID="ddl_Users" runat="server" 
                                    TextBoxClass="textbox1"
                                    ImageButtonClass="imagebutton1"
                                    TooltipClass="tooltip1" 
                                    DropdownClass="dropdown1 drp1" />  
                        </div>
<%--                        <span style="color:Window">نام کاربری  : </span>
                        <asp:DropDownList ID="ddl_Users" runat="server" Height="30px"  Width="230px"></asp:DropDownList>--%>
                    </td>
                </tr>
                <tr>
                    <td>
            ...
            <asp:GridView ID="gv_RacingCurrentForms" ShowFooter="True" 
                ...
                OnPageIndexChanging="gv_RacingCurrentForms_PageIndexChanging" PageSize="10" OnRowCommand="gv_RacingCurrentForms_RowCommand">    
