<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ReportUsersRewardBox.ascx.cs" Inherits="AdminPanel_AdminUserControl_ReportUsersRewardBox" %>
<%@ Register Assembly="PersianDatePickup" Namespace="PersianDatePickup" TagPrefix="pcal" %>
<asp:ScriptManager ID="ScriptManager1" runat="server">
</asp:ScriptManager>
<fieldset>
    <legend style="color: #ffcc00;">گزارش صندوق جوایز کاربران</legend>
    <fieldset>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <div>
                    <fieldset>
                        <asp:GridView ID="gv_usersRewardReport" runat="server" 
                            ...
                            AllowPaging="True" onpageindexchanging="gv_usersRewardReport_PageIndexChanging">
