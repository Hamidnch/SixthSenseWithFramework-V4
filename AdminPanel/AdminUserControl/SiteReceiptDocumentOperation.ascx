<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SiteReceiptDocumentOperation.ascx.cs" Inherits="AdminPanel_AdminUserControl_SiteReceiptDocumentOperation" %>
...
<fieldset>
    <legend style="color: #ffcc00;">لیست اسناد دریافت - صندوق سایت</legend>
    <fieldset>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <fieldset>
                <asp:GridView ID="gv_siteReceiptDocuments" runat="server" AutoGenerateColumns="False"
                    CssClass="GridViewStyle" HeaderStyle-CssClass="HeaderStyle" PagerStyle-CssClass="PagerStyle"
                    HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" AllowPaging="True" 
                    onpageindexchanging="gv_siteReceiptDocuments_PageIndexChanging" 
                    onrowdatabound="gv_siteReceiptDocuments_RowDataBound" 
                    onrowcommand="gv_siteReceiptDocuments_RowCommand">
            ...
            <table>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>                                        
                                        ...
                                        <select id="txt_Year" style="width: 70px; height: 26px" name="txt" class="autoTable_txt"></select>                                        
                                    </td>
                ...
                <tr>
                    <td colspan="4">
                        ...
                        <input type="button" value="بازگشت" class="submit" onclick="$('#dialog-receipt').dialog('close');" />
...
<div id="divShowReceipt" aria-labelledby="ui-dialog-title-dialog-form" role="dialog"
            ...
            width: 800px; top: 82px; left: 460px;">
    <div class="ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix">
        <span id="ui-dialog-title-dialog-form2" class="ui-dialog-title">ویرایش</span><a role="button"
            class="ui-dialog-titlebar-close ui-corner-all" href="#"><span class="ui-icon ui-icon-closethick">بستن</span></a></div>
    <div style="width: auto; min-height: 0px; height: auto" class="ui-dialog-content ui-widget-content"
            ...
            <asp:UpdatePanel runat="server" UpdateMode="Always">
                <ContentTemplate>
                    ...
                    <legend style="color: #262626;">                    
                        <table>
                            <tr>
                                <td>شماره سند : <span id="Span1"><asp:Label id="lbl_ReceiptDocID" runat="server"></asp:Label></span></td>
                                    ...
                                    <asp:GridView ID="gv_ShowReceipt" runat="server" AutoGenerateColumns="false"  CssClass="GridViewStyle" HeaderStyle-CssClass="HeaderStyle" PagerStyle-CssClass="PagerStyle">                        
                                        ...
                                        <Columns>                                    
                                            ...
                                            <asp:TemplateField HeaderText="شماره مدرک" SortExpression="ReceiptDoc_DocumentNumber">
                                                <ItemStyle Width="20%" VerticalAlign="Middle" HorizontalAlign="Center" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_ReceiptDoc_DocumentNumber" runat="server" Text='<%# Eval("ReceiptDoc_DocumentNumber", "{0}") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
...
<script type="text/javascript">
    ...
    function getSiteReceiptInfo()
    {
        $.PageMethod('GetSiteReceiptInfo', onSiteReceiptInfoSuccess, onSiteReceiptInfoFail);
        function onSiteReceiptInfoSuccess(result)
        {
            var info = result.d;
        ...
        function onSiteReceiptInfoFail(response)
        {
            alert("خطا");
            $.unblockUI();
        }
    }
    function addAmountToSiteBoxByReceipt(amount)
    {
        setBlock();
        $.PageMethod('AddAmountToSiteBoxByReceipt', onAddAmountSuccess, onAddAmountFail, 'amount', amount);
    ...
    $(document).ready(function ()
    {
        ...
        $("#dialog-receipt").dialog({
            ...
            show: 'clip', hide: 'clip', stack: true, position: 'center', title: 'سند دریافت - صندوق سایت', modal: true
        });
        $("#dialog-showReceipt").dialog({
            autoOpen: false, resizable: false, height: 'auto', width: 850, direction: 'rtl',
            show: 'clip', hide: 'clip', stack: true, position: 'center', title: 'نمایش سند دریافت', modal: true
        });
        ...
        $('#register').live('click', function (e)
        {
            ...
            $(".autoTable tbody tr").each(function (item, i)
            {
                ...
                saveReceipt(receiptID, "1", oldAmount, n, receiptDate, txt_Desc, txt_DocNumber, txt_Amount, txt_comment, "-1");
                $('span[id$=CurrentRemainAmountBox]').html(parseFloat(oldAmount) + parseFloat(txt_Amount));
                remainAmount += parseFloat(txt_Amount);
            });
            addAmountToSiteBoxByReceipt(sumAmount);
