<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ReportGovernBox.ascx.cs" Inherits="AdminPanel_AdminUserControl_ReportGovernBox" %>
...
<fieldset>
    <legend style="color: #ffcc00;">گزارش صندوق دولتی</legend>
    <fieldset>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <div>
                    <fieldset>
                        <asp:GridView ID="gv_governReport" runat="server" AutoGenerateColumns="False" AlternatingRowStyle-Height="35px"
                            CssClass="GridViewStyle" HeaderStyle-CssClass="HeaderStyle" PagerStyle-CssClass="PagerStyle"
                            HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" 
                            AllowPaging="True" onpageindexchanging="gv_governReport_PageIndexChanging">
