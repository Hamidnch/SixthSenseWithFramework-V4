<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SportRacingArchiveForms.ascx.cs" Inherits="AdminPanel_AdminUserControl_SportRacingArchiveForms" %>
<%@ Register Assembly="MultiDropDown" Namespace="MultiDropDownLib" TagPrefix="MultiDropDownLib" %>
<asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
<asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
        <fieldset>
            <legend>آرشیو فرمهای غیرفعال مسابقات</legend>
            <table style="width: 100%">
                <tr>
                    <td>
                        <span style="color:Window"> شماره مسابقه : </span>
                        <asp:DropDownList ID="ddl_RacingInfoID" runat="server" Height="30px" Width="230px">
                        </asp:DropDownList>
                    </td>
                    <td>
            ...
            <asp:GridView ID="gv_RacingArchiveForms" ShowFooter="True" 
                ...
                onpageindexchanging="gv_RacingArchiveForms_PageIndexChanging" PageSize="10" onrowcommand="gv_RacingArchiveForms_RowCommand">
