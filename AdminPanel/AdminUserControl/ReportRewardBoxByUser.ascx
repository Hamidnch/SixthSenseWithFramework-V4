<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ReportRewardBoxByUser.ascx.cs" Inherits="AdminPanel_AdminUserControl_ReportRewardBoxByUser" %>
<%@ Register Assembly="PersianDatePickup" Namespace="PersianDatePickup" TagPrefix="pcal" %>
<asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
<fieldset>
    <legend style="color: #ffcc00;">گزارش گردش مالی صندوق جایزه کاربران</legend>
    <fieldset>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <div>
                    <fieldset>
                        <asp:GridView ID="gv_RewardByUserReport" runat="server" 
                            ...
                            AllowPaging="True" onpageindexchanging="gv_RewardByUserReport_PageIndexChanging">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="شرح" SortExpression="DocumentsBox_Comment">
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lbl_DocumentsBox_Comment" runat="server" Text='<%#  PersianClass.getPersianNumberStyle(Eval("DocumentsBox_Comment", "{0}")) %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
