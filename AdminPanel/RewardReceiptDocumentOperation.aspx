<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/Admin.master" AutoEventWireup="true" CodeFile="RewardReceiptDocumentOperation.aspx.cs" Inherits="AdminPanel_RewardReceiptDocumentOperation" %>

<%@ Register src="AdminUserControl/RewardReceiptDocumentOperation.ascx" tagname="RewardReceiptDocumentOperation" tagprefix="uc1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <uc1:RewardReceiptDocumentOperation ID="RewardReceiptDocumentOperation1" 
        runat="server" />
</asp:Content>
