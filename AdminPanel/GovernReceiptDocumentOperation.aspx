<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/Admin.master" AutoEventWireup="true" CodeFile="GovernReceiptDocumentOperation.aspx.cs" Inherits="AdminPanel_GovernReceiptDocumentOperation" %>
<%@ Register src="AdminUserControl/GovernReceiptDocumentOperation.ascx" tagname="GovernReceiptDocumentOperation" tagprefix="uc1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <uc1:GovernReceiptDocumentOperation ID="GovernReceiptDocumentOperation1" 
        runat="server" />
</asp:Content>
