<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/Admin.master" AutoEventWireup="true" CodeFile="CharitablePaymentDocumentOperation.aspx.cs" Inherits="AdminPanel_CharitablePaymentDocumentOperation" %>

<%@ Register src="AdminUserControl/CharitablePaymentDocumentOperation.ascx" tagname="CharitablePaymentDocumentOperation" tagprefix="uc1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <uc1:CharitablePaymentDocumentOperation ID="CharitablePaymentDocumentOperation1" 
        runat="server" />
</asp:Content>
