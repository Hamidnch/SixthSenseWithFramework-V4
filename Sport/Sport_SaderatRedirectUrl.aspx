<%@ Page Title="" Language="C#" MasterPageFile="~/Sport/SportPayment.master" AutoEventWireup="true" ValidateRequest="false"
CodeFile="Sport_SaderatRedirectUrl.aspx.cs" Inherits="Sport_Sport_SaderatRedirectUrl" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <div id="divBank" style="font-family: Tahoma; direction: rtl;width:99%; text-align:center">
        <p style="color: White; font-size: 50px">بانک صادرات ایران</p>
        <br />
        <br />
